...
if "!choice!"=="?1" (
	echo When enabled, two extra windows with more info about what Vyond Remastered is doing.
...
if exist "server\characters\characters.zip" (
	...
	if "!choice!"=="?6" (
		echo When first getting Vyond: Remastered, all non-stock characters are put into a single zip file.
