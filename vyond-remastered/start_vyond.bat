...
:: Author: David lol
:: License: MIT
set WRAPPER_VER=2.2.0 (Build 1 Public Beta)
set WRAPPER_BLD=1
...
if not exist "utilities\checks\disclaimer.txt" (
	echo DISCLAIMER
  echo:
	echo Vyond: Remastered is a project to preserve the original GoAnimate flash-based themes.
...
echo A project from Emmas Animation Videos adapted by benson
...
:exitwithstyle
title Vyond: Remastered v!WRAPPER_VER! [Shutting down... WITH STYLE]
echo SHUTTING DOWN THE VYOND REMASTERED
PING -n 3 127.0.0.1>nul
color 9b
...
PING -n 3 127.0.0.1>nul
echo TIME TO ELIMINATE VYOND REMASTERED
PING -n 3 127.0.0.1>nul
