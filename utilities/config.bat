...
:: You should be using settings.bat, and not touching this. Vyond Remastered relies on this file remaining consistent, and it's easy to mess that up.

:: Opens this file in Notepad when run
setlocal
if "%SUBSCRIPT%"=="" ( pushd "C:\Users\david\OneDrive\Desktop\vyond-remastered\utilities\" & start notepad.exe config.bat & exit )
endlocal

:: Shows exactly Vyond Remastered is doing, and never clears the screen. Useful for development and troubleshooting. Default: n
...
:: Opens Vyond Remastered in an included copy of ungoogled-chromium. Allows continued use of Flash as modern browsers disable it. Default: y
